...
const sampleTemplateData = {
  ...
  description: 'Ultra-modern design with gradient backgrounds, animated elements, and glass-morphism effects. Perfect for showcasing professional experience and technical skills with a contemporary aesthetic.',
  category: 'modern',
  features: [
  ...
  try {
    ...
    const templates = [
      ...
      },
      {
        ...
        name: 'Minimal Clean',
        category: 'minimal',
        description: 'Clean and minimal design focusing on typography and white space. Perfect for professionals who prefer understated elegance.',
      ...
      },
      {
        ...
        category: 'creative',
        description: 'Bold and vibrant design with creative layouts and animations. Ideal for designers, artists, and creative professionals.',
      ...
      },
      {
        ...
        category: 'developer',
        description: 'Technical design highlighting code projects, GitHub integration, and developer-specific sections.',
      ...
      },
      {
        ...
        category: 'executive',
        description: 'Sophisticated design for executives and business leaders with focus on achievements and leadership.',
