...
import {
  XCircle, Save, RefreshCw, AlertCircle, Calendar, MapPin,
  DollarSign, Building2, Briefcase, FileText, Bot, Link as LinkIcon,
  User, Mail, Phone, Clock, Target, Edit3,
  IndianRupee
} from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600 mt-1">
                Update details for {job.title} at {job.company}
              </p>
            </div>
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="bg-slate-50 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label className="block text-sm placeholder:!text-gray-400 font-medium text-slate-700 mb-2">
                  Location
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 border placeholder:!text-gray-400  border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="bg-slate-50 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-3 top-1/2 placeholder:!text-gray-400 transform -translate-y-1/2 text-slate-400 w-4 h-4" />
                  <input
                    type="text"
          ...
          <div className="bg-slate-50 rounded-xl p-6">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-slate-200 rounded-lg placeholder:!text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
        ...
        <div className="sticky bottom-0 bg-white/95 backdrop-blur-sm border-t border-slate-200 p-6 rounded-b-2xl">
          <div className="flex gap-3">
            <button
              type="button"
              onClick={handleClose}
              className="flex-1 bg-slate-200 cursor-pointer hover:bg-slate-300 text-slate-700 px-4 py-3 rounded-lg font-medium transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white px-4 py-3 rounded-lg font-medium transition-colors flex items-center justify-center cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
