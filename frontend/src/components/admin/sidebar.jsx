...
const Sidebar = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white/95 backdrop-blur-xl border-r border-gray-200/60 shadow-2xl transform transition-transform duration-300 ease-out ${
              ...
              {sidebarItems.map((item) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div
                        className={`relative ${isActive ? "text-white" : "text-gray-500 group-hover:text-blue-600"}`}
                      >
