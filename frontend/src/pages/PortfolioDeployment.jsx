...
const PortfolioDeployment = () => {
  ...
  const getStatusConfig = () => {
    switch (deploymentStatus) {
      case 'checking':
        return {
          icon: <Loader2 className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 animate-spin text-blue-500" />,
      ...
      case 'deploying':
        return {
          icon: <Rocket className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-blue-500 animate-pulse" />,
      ...
      case 'deployed':
        return {
          icon: <CheckCircle className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-green-500" />,
      ...
      case 'error':
        return {
          icon: <AlertCircle className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-red-500" />,
      ...
      case 'profile-and-template-required':
        return {
          icon: <Settings className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-orange-500" />,
      ...
      default:
        return {
          icon: <Globe className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-blue-500" />,
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 -mt-4 sm:-mt-6 lg:-mt-8 relative z-10">
            ...
            <div className="text-center mb-6 sm:mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-6">
                {username && (
                  <div className="bg-white/60 backdrop-blur-sm rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 border border-white/40">
                    <span className="text-xs sm:text-sm text-slate-600">Username</span>
                    <div className="font-semibold text-slate-800 text-sm sm:text-base">@{username}</div>
                  </div>
                )}
                {selectedTemplate && (
                  <div className="bg-white/60 backdrop-blur-sm rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 border border-white/40">
                    <span className="text-xs sm:text-sm text-slate-600">Template</span>
                    <div className="font-semibold text-slate-800 text-sm sm:text-base break-words">{selectedTemplate}</div>
                  </div>
                )}
              ...
              {deploymentStatus === 'deploying' && (
                <div className="w-full max-w-sm sm:max-w-md mx-auto mb-4 sm:mb-6">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 mt-2">{Math.round(deploymentProgress)}% complete</p>
                </div>
              )}
            </div>
                ...
                <>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">Unpublish Portfolio</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8 lg:mb-10">
            ...
            >
              ...
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-800 mb-2 sm:mb-3 text-center sm:text-left">Edit Profile</h3>
              <p className="text-slate-600 leading-relaxed text-sm sm:text-base text-center sm:text-left">Update your information and redeploy with fresh content</p>
            </button>
            ...
            >
              ...
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-800 mb-2 sm:mb-3 text-center sm:text-left">Change Template</h3>
              <p className="text-slate-600 leading-relaxed text-sm sm:text-base text-center sm:text-left">Switch to a different design that matches your style</p>
            </button>
            ...
            >
              ...
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-800 mb-2 sm:mb-3 text-center sm:text-left">View Live</h3>
              <p className="text-slate-600 leading-relaxed text-sm sm:text-base text-center sm:text-left">See your portfolio in action and share it with others</p>
            </button>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10 lg:mb-12">
              <div className="bg-gradient-to-br from-blue-500/10 to-indigo-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-blue-200/40">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-blue-600 text-xs sm:text-sm font-medium">Deployment Time</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-800">{"< 2 min"}</p>
                  </div>
              ...
              <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-green-200/40">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-green-600 text-xs sm:text-sm font-medium">Performance</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-800">Optimized</p>
                  </div>
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-purple-200/40">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-purple-600 text-xs sm:text-sm font-medium">Accessibility</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-slate-800">100%</p>
                  </div>
