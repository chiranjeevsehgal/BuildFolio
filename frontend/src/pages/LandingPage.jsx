...
import { ArrowRight, Zap, Globe, Users, Mail, Sparkles, Check, Star, User, LogOut, Briefcase, Bot, Target, TrendingUp, FileText, Timer, CheckCircle, XCircle, Calendar, MapPin, Building2 } from 'lucide-react';
          ...
          <div className="text-center">
            <div className="mb-6">
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                ...
                {isLoggedIn ? 'Welcome back!' : 'Portfolio + Job Tracker + AI Insights'}
              </span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Professional portfolio creation and job tracking made simple with powerful features
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group p-8 rounded-2xl border border-slate-200 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Smart Job Tracking</h3>
              <p className="text-slate-600 leading-relaxed">
                Organize applications with Kanban boards, AI insights, and success predictions.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Organize your job search with our intuitive Kanban board, get AI-powered resume insights,
              and track your success probability for every application.
            </p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-2xl p-8 mb-16 border border-white/50">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
              ...
              <div className="bg-gradient-to-br from-blue-50/80 to-indigo-50/80 border-2 border-blue-200/50 rounded-2xl shadow-lg overflow-hidden">
                <div className="bg-blue-600 text-white px-4 py-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-bold">3</span>
                  </div>
                </div>
                <div className="p-3 space-y-3">
                  <div className="bg-white/95 rounded-xl p-3 shadow-sm border-l-4 border-l-blue-500">
                    <h4 className="font-semibold text-slate-800 text-sm mb-1">Frontend Developer</h4>
                  ...
                  <div className="bg-white/95 rounded-xl p-3 shadow-sm border-l-4 border-l-green-500">
                    <h4 className="font-semibold text-slate-800 text-sm mb-1">React Developer</h4>
                    <p className="text-slate-600 text-xs flex items-center">
                      <Building2 className="w-3 h-3 mr-1" />
                      StartupXYZ
                    </p>
              ...
              <div className="bg-gradient-to-br from-yellow-50/80 to-orange-50/80 border-2 border-yellow-200/50 rounded-2xl shadow-lg overflow-hidden">
                <div className="bg-yellow-600 text-white px-4 py-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-bold">2</span>
                  </div>
                </div>
                <div className="p-3 space-y-3">
                  <div className="bg-white/95 rounded-xl p-3 shadow-sm border-l-4 border-l-yellow-500">
                    <h4 className="font-semibold text-slate-800 text-sm mb-1">Full Stack Dev</h4>
                    <p className="text-slate-600 text-xs flex items-center">
                      <Building2 className="w-3 h-3 mr-1" />
                      InnovateLabs
                    </p>
              ...
              <div className="bg-gradient-to-br from-purple-50/80 to-pink-50/80 border-2 border-purple-200/50 rounded-2xl shadow-lg overflow-hidden">
                <div className="bg-purple-600 text-white px-4 py-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-bold">1</span>
                  </div>
                </div>
                <div className="p-3 space-y-3">
                  <div className="bg-white/95 rounded-xl p-3 shadow-sm border-l-4 border-l-purple-500">
                    <h4 className="font-semibold text-slate-800 text-sm mb-1">Senior Developer</h4>
                    <p className="text-slate-600 text-xs flex items-center">
                      <Building2 className="w-3 h-3 mr-1" />
                      MegaCorp
                    </p>
              ...
              <div className="bg-gradient-to-br from-green-50/80 to-emerald-50/80 border-2 border-green-200/50 rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="p-3 space-y-3">
                  <div className="bg-white/95 rounded-xl p-3 shadow-sm border-l-4 border-l-green-500">
                    <h4 className="font-semibold text-slate-800 text-sm mb-1">Lead Developer</h4>
                    <p className="text-slate-600 text-xs flex items-center">
                      <Building2 className="w-3 h-3 mr-1" />
                      DreamJob Inc
                    </p>
              ...
              <div className="bg-gradient-to-br from-red-50/80 to-pink-50/80 border-2 border-red-200/50 rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="p-3 space-y-3">
                  <div className="bg-white/95 rounded-xl p-3 shadow-sm border-l-4 border-l-red-500">
                    <h4 className="font-semibold text-slate-800 text-sm mb-1">Backend Dev</h4>
                    <p className="text-slate-600 text-xs flex items-center">
                      <Building2 className="w-3 h-3 mr-1" />
                      TechGiant
                    </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white/70 backdrop-blur-sm p-8 rounded-2xl border border-white/50 hover:shadow-xl transition-all duration-300 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-4">AI Resume Analysis</h3>
              <p className="text-slate-600 leading-relaxed">
                Get personalized resume optimization tips with scoring and priority-based suggestions for each job application.
              </p>
            </div>
            ...
            <div className="group bg-white/70 backdrop-blur-sm p-8 rounded-2xl border border-white/50 hover:shadow-xl transition-all duration-300 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Smart Job Matching</h3>
              <p className="text-slate-600 leading-relaxed">
                AI analyzes your skills against job requirements, showing match percentages and areas for improvement.
              </p>
            </div>
            ...
            <div className="group bg-white/70 backdrop-blur-sm p-8 rounded-2xl border border-white/50 hover:shadow-xl transition-all duration-300 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Success Prediction</h3>
              <p className="text-slate-600 leading-relaxed">
                Get AI-calculated probability scores for each application with detailed factor breakdowns and insights.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Build Portfolio</h3>
              <p className="text-slate-600">
                Sign up, customize your professional information, and choose from beautiful templates.
              </p>
            </div>

            <div className="text-center">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl transition-all duration-300 ${isLoggedIn && currentUser?.selectedTemplate ? 'bg-green-500' : 'bg-gradient-to-r from-purple-500 to-pink-600'
                }`}>
                {isLoggedIn && currentUser?.selectedTemplate ? <Check className="w-8 h-8" /> : '2'}
              </div>
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Track Applications</h3>
              <p className="text-slate-600">
                Use our smart Kanban board to organize and track all your job applications in one place.
              </p>
            </div>

            <div className="text-center">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl transition-all duration-300 bg-gradient-to-r from-green-500 to-emerald-600`}>
                <Bot className="w-8 h-8" />
              </div>
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Get AI Insights</h3>
              <p className="text-slate-600">
                Upload your resume for personalized optimization tips, job matching analysis, and success predictions.
              </p>
            </div>

            <div className="text-center">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl transition-all duration-300 ${isLoggedIn && currentUser?.portfolioDeployed ? 'bg-green-500' : 'bg-gradient-to-r from-yellow-500 to-orange-600'
                }`}>
                {isLoggedIn && currentUser?.portfolioDeployed ? <Check className="w-8 h-8" /> : <Star className="w-8 h-8" />}
              </div>
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Land Your Dream Job</h3>
              <p className="text-slate-600">
                Share your portfolio, apply strategically with AI guidance, and track your path to success.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="relative flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0">
              ...
              <div className="text-center lg:text-left lg:flex-1">
                <div className="flex items-center justify-center lg:justify-start mb-6">
                  ...
                  <div>
                    <h3 className="text-3xl lg:text-4xl font-bold text-white mb-2">AI-Powered Career Intelligence</h3>
                    <p className="text-purple-100 text-lg">Transform your job search with smart insights</p>
                  </div>
                </div>
                <p className="text-purple-100 text-lg mb-8 lg:max-w-2xl">
                  Our advanced AI analyzes your resume, matches you with perfect opportunities,
                  and predicts your success rate for every application. Stop guessing - start succeeding.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:flex-1 lg:max-w-lg">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300 cursor-pointer group">
                  ...
                  <h4 className="font-semibold text-white mb-2">Resume Scoring</h4>
                  <p className="text-purple-100 text-sm">Get percentage scores with detailed improvement suggestions</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300 cursor-pointer group">
                  ...
                  <h4 className="font-semibold text-white mb-2">Skill Matching</h4>
                  <p className="text-purple-100 text-sm">See how your skills align with job requirements</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300 cursor-pointer group">
                  ...
                  <p className="text-purple-100 text-sm">AI calculates your probability of getting hired</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300 cursor-pointer group">
                  ...
                  <h4 className="font-semibold text-white mb-2">Smart Tracking</h4>
                  <p className="text-purple-100 text-sm">Organize applications with drag-and-drop boards</p>
                </div>
              </div>
            </div>
          </div>
