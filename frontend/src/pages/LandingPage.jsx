    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
              ...
              {loading ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-2 rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 shadow-sm"
                  >
                    Get Started
                  </button>
                </>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                onClick={handleGetStarted}
                className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-8 py-4 rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center font-semibold text-lg"
              >
                {isLoggedIn ? (
                  currentUser?.portfolioDeployed ? (
                    <>
              ...
              <button 
                ...
                className="border-2 border-slate-300 text-slate-700 px-8 py-4 rounded-xl hover:border-slate-400 hover:bg-slate-50 transition-all duration-200 font-semibold text-lg"
              >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl transition-all duration-300 ${
                isLoggedIn ? 'bg-green-500' : 'bg-gradient-to-r from-blue-500 to-indigo-600'
              }`}>
            ...
            <div className="text-center">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl transition-all duration-300 ${
                isLoggedIn && currentUser?.selectedTemplate ? 'bg-green-500' : 'bg-gradient-to-r from-blue-500 to-indigo-600'
              }`}>
            ...
            <div className="text-center">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl transition-all duration-300 ${
                isLoggedIn && currentUser?.portfolioDeployed ? 'bg-green-500' : 'bg-gradient-to-r from-blue-500 to-indigo-600'
              }`}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-500 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            {isLoggedIn ? 'Continue Building Your Portfolio' : 'Ready to Build Your Portfolio?'}
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            {isLoggedIn ? 
              'Take the next step in showcasing your professional journey' :
              'Join thousands of professionals who have launched their careers with PortfolioGenerator'
            }
          </p>
          <button 
            onClick={handleGetStarted}
            className="bg-white text-blue-600 px-8 py-4 rounded-xl hover:bg-slate-50 transition-all duration-200 shadow-lg hover:shadow-xl font-semibold text-lg flex items-center justify-center mx-auto"
          >
            {isLoggedIn ? 'Continue Setup' : 'Get Started for Free'}
            <ArrowRight className="ml-2 w-5 h-5" />
          </button>
        </div>
      </section>
