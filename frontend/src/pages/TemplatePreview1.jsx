...
const TemplatePreview1 = () => {
  ...
  // Sample user data for preview (will be fetched from API)
  const sampleUserData = {
    ...
    professional: {
      ...
      summary: "Experienced software engineer with 8+ years of expertise in building scalable web applications using React, Node.js, and cloud technologies. Passionate about creating innovative solutions that drive business growth and deliver exceptional user experiences.",
    ...
    experience: [
      {
        ...
        endDate: "",
        current: true,
        description: "Lead development of enterprise web applications serving 100k+ users. Architected microservices infrastructure resulting in 40% improved performance. Mentored junior developers and established best practices for code quality and deployment."
      },
      {
        ...
        endDate: "2021-02",
        current: false,
        description: "Developed full-stack features for B2B SaaS platform. Implemented real-time chat system handling 10k+ concurrent users. Optimized database queries reducing load times by 60%."
      }
    ],
    education: [
      {
    ...
    projects: [
      {
        ...
        description: "Full-stack e-commerce solution with real-time inventory management, payment processing, and admin dashboard. Built with React, Node.js, and Stripe API.",
      ...
      },
      {
        ...
        skills: ["Vue.js", "Firebase", "WebSocket", "PWA"],
      ...
      },
      {
        ...
        description: "Data visualization dashboard for weather patterns using D3.js and external weather APIs. Features interactive charts and predictive modeling.",
        skills: ["D3.js", "Python", "FastAPI", "PostgreSQL"],
