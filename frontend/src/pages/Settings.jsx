...
const Settings = () => {
  ...
  const handleSavePersonalData = async () => {
    ...
    try {
      ...
      payload.lastName = personalData.lastName
      ...
      if (response.data.success) {
        ...
        toast.success(
          "Personal information updated successfully. Make sure to redeploy your portfolio to see the changes.",
          { duration: 3000 },
        );
        setIsEditing((prev) => ({ ...prev, personal: false }));
      } else {
        throw new Error(
          response.data.message || "Failed to save personal data",
        );
      }
    } catch (error) {
  ...
  const handleSaveResumeData = async () => {
    ...
    try {
      ...
      payload.resumeExperience = resumeData.resumeExperience
        ? resumeData.resumeExperience.trim()
        : "";
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`pb-3 sm:pb-4 px-1 border-b-2 cursor-pointer font-medium text-xs sm:text-sm transition-colors duration-200 flex items-center space-x-1 sm:space-x-2 whitespace-nowrap ${
                        activeTab === tab.id
                ...
                <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                      <div>
                        ...
                        {isEditing.personal ? (
                          ...
                          <p className="text-slate-800 py-2 sm:py-3 text-sm sm:text-base">
                  ...
                  <div className="bg-white/60 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200/50">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">
                          What industry are you pursuing?
                        </label>
                        {isEditing.resume ? (
                          <select
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">
                          How quickly are you looking to get a new job?
                        </label>
                        {isEditing.resume ? (
                          <select
                  ...
                  <div className="bg-white/60 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200/50">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-3 sm:space-y-0">
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-blue-600 font-medium text-sm sm:text-base break-all">
                          {accountData.email}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start space-y-4 lg:space-y-0">
                      <div className="min-w-0 flex-1 lg:pr-4">
                        ...
                        <p className="text-red-700 text-xs sm:text-sm leading-relaxed">
                          When you choose to deactivate your account, you will
                          no longer have access to BuildFolio's services, and
