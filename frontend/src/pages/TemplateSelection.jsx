      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {message.content && message.type !== 'info' && (
            <div className={`fixed top-4 right-4 z-50 rounded-lg p-4 flex items-center space-x-3 shadow-lg max-w-sm ${message.type === 'success'
                ...
                {categories.map((category) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 ${filterCategory === category.id
          ...
          <div className="grid lg:grid-cols-1 xl:grid-cols-1 gap-8 mb-12">
            {filteredTemplates.map((template) => {
              ...
              return (
                <div
                  key={templateId}
                  className={`bg-white rounded-2xl shadow-xl border-2 transition-all duration-300 hover:shadow-2xl ${isCurrentlySelected
                    ...
                    <div className="lg:w-1/2">
                      <div className="aspect-[4/3] lg:aspect-[3/2] bg-gradient-to-br from-slate-100 to-slate-200 rounded-t-2xl lg:rounded-l-2xl lg:rounded-tr-none overflow-hidden relative">
                        ...
                        <div className="w-full h-full flex items-center justify-center p-8">
                          <div className="text-center">
                            <div className={`w-20 h-20 bg-gradient-to-r ${isCurrentlySelected
                      ...
                      <div className="flex space-x-3">
                        {isCurrentlySelected ? (
                          ...
                          <button
                            ...
                            className={`flex-1 py-3 px-6 rounded-xl font-semibold transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed ${isSelected
